...
Async normalizer workers, parquet partitions, and the terva hook polish are still open. The synchronous projector still implements terva only. A shallow clone has an empty project_id because the root commit is not in the object store.
