...
// a missing directory is still watched, and Run reports it. Claude and
// Codex are skipped when the directory is not there.
type source struct {
...
// sources resolves terva, Claude Code, and Codex. terva's home is
// required. An optional harness whose default cannot be named, because
// HOME is unset and the override is unset, is left out. A set override
// is kept even when the directory does not exist yet; Discover treats
